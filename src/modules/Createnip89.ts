...
export async function createNip89(id:string) {
    ...
    tags.push(["k","5050"])
    tags.push(["d", "D94C72C241D1C73B2C36EEA73E9FB"])

    const event1 = await createEvent(31990,tags, JSON.stringify(content), decryptedKey);
